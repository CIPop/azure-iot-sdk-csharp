...
namespace Microsoft.Azure.Devices.Client
{
    ...
    public abstract class ModuleAuthenticationWithTokenRefresh : AuthenticationWithTokenRefresh
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="ModuleAuthenticationWithTokenRefresh"/> class using default
        /// TTL and TTL buffer time settings.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="ModuleAuthenticationWithTokenRefresh"/> class.</summary>
